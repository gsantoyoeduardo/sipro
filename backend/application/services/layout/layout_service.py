...
class ZonaService:
    @staticmethod
    def listar(idsucursal: uuid.UUID | None = None, idalmacen: uuid.UUID | None = None):
        return zona_repo.get_all(idsucursal=idsucursal, idalmacen=idalmacen)
    ...
    @staticmethod
    def listar_estantes(idzona: uuid.UUID):
        return zona_repo.get_estantes(idzona)

    @staticmethod
    def crear_estante(idzona: uuid.UUID, data: dict):
        data['idzona'] = idzona
...
class EstanteService:
    ...
    def listar(idzona: uuid.UUID | None = None):
        return estante_repo.get_all(idzona=idzona)
...
class NivelService:
    ...
    def listar(idestante: uuid.UUID | None = None):
        return nivel_repo.get_all(idestante=idestante)
...
class UbicacionService:
    ...
    def listar(idnivel: uuid.UUID | None = None):
        return ubicacion_repo.get_all(idnivel=idnivel)
...
class NodoService:
    @staticmethod
    def listar(idsucursal: uuid.UUID | None = None, idalmacen: uuid.UUID | None = None):
        return nodo_repo.get_all(idsucursal=idsucursal, idalmacen=idalmacen)
...
class RutaService:
    @staticmethod
    def calcular(origen_id: uuid.UUID, destino_id: uuid.UUID, ancho_minimo: float = 0):
        try:
        ...
        if ancho_minimo > 0:
            conexiones = conexiones.filter(ancho__gte=ancho_minimo)
