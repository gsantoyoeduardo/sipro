...
class TransferenciaListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Transferencia
        fields = ['idtransferencia', 'numero_transferencia', 'idalmacen_origen', 'origen_nombre', 'idalmacen_destino', 'destino_nombre', 'idusuario', 'usuario_nombre', 'estado_transferencia', 'fecha_creacion', 'fecha_envio', 'fecha_recepcion', 'notas', 'total_items']
