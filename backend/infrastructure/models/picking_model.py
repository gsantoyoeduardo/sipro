...
class OrdenPicking(AuditableBaseModel):
    ...
    estado_orden = models.CharField(max_length=20, choices=ESTADO_CHOICES, default='pendiente')
...
class DetallePicking(AuditableBaseModel):
    ...
    estado_detalle = models.CharField(max_length=20, choices=[('pendiente','Pendiente'),('en_proceso','En Proceso'),('completado','Completado'),('incidencia','Con Incidencia')], default='pendiente')
