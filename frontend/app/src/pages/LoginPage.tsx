      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 sm:p-8 rounded-xl shadow-lg w-full max-w-sm sm:max-w-md">
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className={`w-full px-3 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${fieldErrors.ruc ? 'border-red-500' : ''}`}
            required
          />
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className={`w-full px-3 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${fieldErrors.usuario ? 'border-red-500' : ''}`}
            required
          />
        ...
        <div className="mb-6">
          ...
          <input
            ...
            className={`w-full px-3 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${fieldErrors.password ? 'border-red-500' : ''}`}
            required
          />
