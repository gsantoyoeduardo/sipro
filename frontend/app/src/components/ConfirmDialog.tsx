    ...
    <Modal isOpen={isOpen} onClose={onClose} title={title} size="sm">
      ...
      <div className="flex justify-end gap-3">
        ...
        <button
          onClick={onConfirm}
          disabled={isLoading}
          className={`px-4 py-2 text-sm rounded-lg text-white disabled:opacity-50 flex items-center gap-2 ${confirmVariant === 'danger' ? 'bg-red-600 hover:bg-red-700' : 'bg-blue-600 hover:bg-blue-700'}`}
        >
